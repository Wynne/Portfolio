...
(function($){
    ...
    // if (options.image) html += ' style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+ feed.item.condition.code + daynight +'.png); background-repeat: no-repeat;"';
		...
		if (options.image) $('link[rel=stylesheet]').remove();
		if (options.image) $('head').append('<link rel="stylesheet" href="_css/style-'+ daynight +'.css" type="text/css" />');
		// if (options.image) $e.attr('style','background-image: url(_img/bg-' + daynight +'.png); background-repeat: repeat-x;');
    if (options.image) $e.children().attr('style','background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+ feed.item.condition.code + daynight +'.png); background-repeat: no-repeat;');
		// Add item data
